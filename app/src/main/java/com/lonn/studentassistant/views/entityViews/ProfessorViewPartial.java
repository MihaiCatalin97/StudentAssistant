...
public class ProfessorViewPartial extends EntityView<Professor>
{
    ProfessorViewFullBinding binding;

    private ProfessorViewModel model;

    public ProfessorViewPartial(Context context)
    {
        super(context);
    }

    public ProfessorViewPartial(Context context, Professor professor)
    {
        super(context);
        entity = professor;

...
public class StudentBusinessLayer implements IBusinessLayer<Student>
{
    ...
    public StudentBusinessLayer(StudentActivity activity, @Nullable Student entity)
    {
        this.activity = activity;
        this.activityEntity = entity!=null?entity.clone():null;
    ...
    {
        serviceConnections.postRequest(StudentService.class, new GetByIdRequest<>(activityEntity.getKey()), studentCallback);

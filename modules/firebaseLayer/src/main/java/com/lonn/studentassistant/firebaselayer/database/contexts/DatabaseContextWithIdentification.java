...
@Slf4j
public class DatabaseContextWithIdentification<T extends BaseEntity> extends DatabaseContext<T> {
    ...
    public void saveOrUpdate(T entity,
        ...
        IdentificationHash identificationHash = IdentificationHash.of((HashableEntity) entity);

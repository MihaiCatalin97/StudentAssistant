...
public class CourseRecurringClassInputDialog extends RecurringClassInputDialog<CourseViewModel> {

    public CourseRecurringClassInputDialog(Context context, CourseViewModel course,
                                           List<ProfessorViewModel> courseProfessors) {
        super(context, course, courseProfessors);
        setAvailableScheduleClassTypes(new ScheduleClassType[]{LABORATORY, SEMINAR, COURSE});
    }

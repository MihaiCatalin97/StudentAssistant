...
public abstract class FileManagingActivity<T extends EntityViewModel<? extends BaseEntity>> extends EntityActivity<T> {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (filesCategory != null) {
			...
			filesCategory.setOnDeleteAction((FileMetadataViewModel fileViewModel) -> {
				new AlertDialog.Builder(filesCategory.getContext(), R.style.DialogTheme)
						.setTitle("Confirm file deletion")
						.setMessage("Are you sure you want to delete this file?")
						.setPositiveButton("Delete",
								(dialog, which) -> deleteFile(entityKey, fileViewModel))
	...
	protected abstract void deleteFile(String entityKey, FileMetadataViewModel fileMetadata);

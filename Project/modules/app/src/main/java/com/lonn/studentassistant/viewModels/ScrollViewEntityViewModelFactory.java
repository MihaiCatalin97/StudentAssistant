...
public class ScrollViewEntityViewModelFactory {
    public static ScrollViewEntityViewModel getScrollViewEntityViewModel(EntityViewType viewType,
        ...
        if (entity instanceof AnnouncementViewModel) {
            if (viewType.equals(FULL)) {
                return full((AnnouncementViewModel) entity);
            }
            return partial((AnnouncementViewModel) entity);
        }
        return null;
    }
    ...
    private static ScrollViewEntityViewModel partial(AnnouncementViewModel announcementViewModel) {
        String field1 = announcementViewModel.getTitle();
        String field2 = announcementViewModel.getDate().toString();
        String field3 = announcementViewModel.getMessage();
    ...
    private static ScrollViewEntityViewModel full(AnnouncementViewModel announcementViewModel) {
        String field1 = announcementViewModel.getTitle();
        String field2 = announcementViewModel.getDate().toString();
        String field3 = announcementViewModel.getMessage();

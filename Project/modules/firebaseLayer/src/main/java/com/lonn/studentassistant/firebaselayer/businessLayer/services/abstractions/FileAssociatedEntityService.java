...
import com.lonn.studentassistant.firebaselayer.dataAccessLayer.entities.abstractions.FileAssociatedEntity;
...
import com.lonn.studentassistant.firebaselayer.businessLayer.viewModels.abstractions.FileAssociatedEntityViewModel;
...
public abstract class FileAssociatedEntityService<T extends FileAssociatedEntity, V extends Exception, U extends FileAssociatedEntityViewModel<T>>
	...
	public Future<Void, Exception> deleteAndUnlinkFile(U entity, String fileMetadataKey) {
		Future<Void, Exception> result = new Future<>();
